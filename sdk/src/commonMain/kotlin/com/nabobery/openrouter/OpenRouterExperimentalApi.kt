...
/**
 * Marks curated openrouter-kotlin APIs that may change incompatibly in a future minor release — the byte-stream helpers
 ...
 * therefore annotates the experimental curated helpers rather than a beta-resource namespace. Opt in with
 * `@OptIn(OpenRouterExperimentalApi::class)`.
 */
@RequiresOptIn(
    level = RequiresOptIn.Level.WARNING,
    message = "Experimental openrouter-kotlin API: may change in a future minor release. " +
